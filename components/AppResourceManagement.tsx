    ...
    return (
      <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-10 animate-in slide-in-from-right-10 duration-500 max-w-5xl mx-auto">
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 flex justify-end space-x-4">
          ...
          <button 
            onClick={resetForm}
            className="px-8 py-3 bg-gray-50 text-amber-600 border border-amber-100 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-amber-100 transition-all flex items-center shadow-sm active:scale-95"
          >
